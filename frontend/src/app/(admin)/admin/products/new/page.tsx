...
import { Plus, Trash2, ArrowLeft, Link2, FileText, ExternalLink, Upload, X } from 'lucide-react';
...
interface Chapter {
  ...
  price: string;
  order: number;
  uploadMode: 'url' | 'file'; // toggle between URL or file upload
  uploading?: boolean;
...
export default function AddProduct() {
  ...
  const [chapters, setChapters] = useState<Chapter[]>([
    { name: '', pdfUrl: '', price: '', order: 1, uploadMode: 'url' },
  ]);
  ...
  const handlePdfFileUpload = async (index: number, file: File) => {
    ...
    try {
      ...
      // Use adminAxios but with multipart form data
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Fill in the details below to create a new PDF product</p>
        </div>
      </div>
        ...
        <section className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-5">
          ...
          <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100 text-sm text-blue-700">
            ...
            <div>
              ...
              <a href="https://drive.google.com/drive/folders/1Pw5a1kMq_YtVhs3WxK2eBxU7_NlZw2D3" target="_blank" rel="noreferrer" className="underline break-all">
                View your PDF folder
              </a>
              <br />
              To get a chapter PDF URL: right-click a file → Share → Copy link. Then paste it in the chapter URL field below.
            </div>
          </div>
        </section>
              ...
              <div key={index} className="bg-gray-50 border border-gray-100 rounded-2xl p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      type="text" required
                      placeholder={`e.g. Chapter ${index + 1}: Cell Biology`}
                      value={chapter.name}
                  ...
                  <div>
                    ...
                    {chapter.uploadMode === 'url' ? (
                      ...
                      <div>
                        ...
                        {/* Hidden required input to satisfy form validation when file is uploaded */}
